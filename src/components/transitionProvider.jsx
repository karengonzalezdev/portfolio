...
<div key={pathName} className="w-screen h-screen bg-gradient-to-b from-blue-100 to-purple-300">
    ...
    <motion.div className="fixed m-auto top-0 bottom-0 left-0 right-0 text-white capitalize text-2xl md:text-4xl lg:text-6xl cursor-default z-50 w-fit h-fit"
    initial={{opacity:1}}
    animate={{opacity:0}}
    exit={{opacity:0}}
