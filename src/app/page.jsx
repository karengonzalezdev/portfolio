  ...
  return (
    ...
    <div className="h-1/3 lg:h-full lg:w-1/2 relative">
      <Image src="./background.gif" alt="BackgroundImage" fill priority className="" />
        ...
        {/* TEXT CONTAINER */}
        <div className="h-1/2 lg:h-full lg:w-1/2 px-4 flex flex-col gap-5 items-center justify-center text-justify sm:px-6 md:px-8 lg:px-12 xl:px-20 pt-5 sm:pt-5 md:pt-10 lg:pt-0 xl:pt-0 mt-6 sm:mt-5 md:mt-5 lg:mt-0 xl:mt-0">
          {/* TITLE */}
